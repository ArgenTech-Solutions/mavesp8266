...
<h3>Step 1 - Main controller</h3><p><button id="choose-firmware">Choose <i>firmware.bin</i></button> or something like <i>RFDTxMod-V2.00.bin</i></p>
<h3>Step 2 - SPIFFS file system</h3><p><button id="choose-spiffs">Choose <i>spiffs.bin</i></button> or something like <i>RFDTxMod-V2.00.spiffs.bin</i></p>
